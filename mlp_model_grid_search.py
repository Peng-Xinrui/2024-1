...
def main(path, winsize):
    ...
    # 输出到文件的目录
    output_dir = path+'/train_reports/mlp_'+str(winsize)
    ...
    # 定义要尝试的参数范围
    parameter_space = {
        'hidden_layer_sizes': [(10,), (20,), (30,), (50,), (100,), (10, 5), (20, 10), (30, 15), (50, 25)],
        'activation': ['relu'],
        'solver': ['adam'],
        'alpha': [0.0001],
    ...
    # 创建GridSearchCV对象
    clf = GridSearchCV(mlp, parameter_space, n_jobs=-1, cv=3, scoring='accuracy', return_train_score=True)
    ...
    # 导出模型
    dump(clf.best_estimator_, output_dir + '/mlp_model.joblib')
